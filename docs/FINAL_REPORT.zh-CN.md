...
This is a reliable summary-MR product, not a claim that MR alone establishes plant gene causality. SMR/GSMR, coloc, MVMR, MR-PRESSO, functional validation, polyploid haplotype modeling and pan-genome SV causal models are deliberately outside the v1.0 built-in estimator contract. Unsupported methods must be added as versioned adapters with their own tests rather than silently substituted.
