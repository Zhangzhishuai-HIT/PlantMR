...
- version tag `v1.1.0`;
- full English submission manuscript (`docs/PlantMR_submission_manuscript.docx`), synchronized Markdown text, 4 publication figures, 6 result/method tables and 35 DOI-verified scientific references;
